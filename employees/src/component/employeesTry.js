...
import EditEmployee from "./formEmployee";
                                    ...
                                    return (
                                        <TableRow className="tableRow" key={item?.id}>
                                            ...
                                            <TableCell className="noBorder">
                                                <EditIcon className="iconButton" onClick={() => handleClickOpenEditDialog(item)} />
                                                <Dialog
                                                ...
                                                >
                                                    ...
                                                    <DialogContent className="dialog">
                                                        {<EditEmployee item={editEmployee} setItem={setEditEmployee}  />}
                                                    </DialogContent>
                                                    <DialogActions>
